...
@interface RDPopup() <UITextFieldDelegate>
...
- (void) setupTextField {
    ...
    self.customView.messageTextField.text = self.message;
    self.customView.messageTextField.delegate = self;
}
...
- (void) otherButtonAction {
    self.message = self.customView.messageTextField.text;
